...
public class RoomTest {
    ...
    /**
     * Sending valid dir and connectedRoom name into getConnectedRoom. We should get
     * the correct room, which we are going to test with room name that we expect
     */
    @Test
    ...
    /**
     * Sending valid dir but invalid connectedRoom name into getConnectedRoom. We
     * should get the NullPointerException, because we are trying to use method
     * getName() on not existing object.
     */
    ...
    /**
     * Sending invalid dir but valid connectedRoom name into getConnectedRoom. We
     * should get "null", because we can never find any room in our direction.
     */
    @Test
    ...
    /**
     * Sending invalid dir and connectedRoom name into getConnectedRoom. We should
     * get "null", because we can never find any room in our direction. And even if
     * we found it, our room does not exist.
     */
    @Test
     ...
     * We should get the NullPointerException, because we are sending nothing to
     * work with.
     */
    @Test(expected = NullPointerException.class)
